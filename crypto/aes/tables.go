...
// Hardcoded so we won't have to compute it (for now, atleast)
var sbox = [256]byte{
...
// Inverse S-box lookup table -> reverses the S-box substitution
...
// Round constants used in key expansion -> rcon[i] = 2^(i-1) in GF(2^8), 1-indexed (rcon[0] is unused)
